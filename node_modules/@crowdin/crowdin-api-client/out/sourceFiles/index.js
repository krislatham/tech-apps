...
class SourceFiles extends core_1.CrowdinApi {
     ...
     */
    listAssetReferences(projectId, fileId, options) {
     ...
     */
    getAssetReference(projectId, fileId, referenceId) {
     ...
     */
    addAssetReference(projectId, fileId, request) {
        const url = `${this.url}/projects/${projectId}/files/${fileId}/references`;
        return this.post(url, request, this.defaultConfig());
    }
    /**
     ...
     */
    deleteAssetReference(projectId, fileId, referenceId) {
        const url = `${this.url}/projects/${projectId}/files/${fileId}/references/${referenceId}`;
        return this.delete(url, this.defaultConfig());
    }
