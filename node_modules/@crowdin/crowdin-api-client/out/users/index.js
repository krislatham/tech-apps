...
class Users extends core_1.CrowdinApi {
     ...
     */
    listGroupManagers(groupId, options) {
        var _a;
        let url = `${this.url}/groups/${groupId}/managers`;
        url = this.addQueryParam(url, 'teamIds', (_a = options === null || options === void 0 ? void 0 : options.teamIds) === null || _a === void 0 ? void 0 : _a.toString());
     ...
     */
    updateGroupManagers(groupId, request) {
     ...
     */
    getGroupManager(groupId, userId) {
