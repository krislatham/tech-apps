...
class Tasks extends core_1.CrowdinApi {
     ...
     */
    listTasksOwnedByUser(userId, options) {
        ...
        url = this.addQueryParam(url, 'assigneeIds', options === null || options === void 0 ? void 0 : options.assigneeIds);
        url = this.addQueryParam(url, 'creatorIds', options === null || options === void 0 ? void 0 : options.creatorIds);
        url = this.addQueryParam(url, 'targetLanguageIds', options === null || options === void 0 ? void 0 : options.targetLanguageIds);
        url = this.addQueryParam(url, 'sourceLanguageIds', options === null || options === void 0 ? void 0 : options.sourceLanguageIds);
        url = this.addQueryParam(url, 'createdAtFrom', options === null || options === void 0 ? void 0 : options.createdAtFrom);
        url = this.addQueryParam(url, 'createdAtTo', options === null || options === void 0 ? void 0 : options.createdAtTo);
        url = this.addQueryParam(url, 'deadlineFrom', options === null || options === void 0 ? void 0 : options.deadlineFrom);
        url = this.addQueryParam(url, 'deadlineTo', options === null || options === void 0 ? void 0 : options.deadlineTo);
        return this.getList(url, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.offset);
    }
    /**
     * @param options optional parameters for the request
